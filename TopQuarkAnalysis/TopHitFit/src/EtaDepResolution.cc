...
EtaDepResolution::FindResolution(const double& eta) const
{
  for (std::vector<EtaDepResElement>::const_iterator res = _EtaDepResElement.begin(); res != _EtaDepResElement.end(); ++res) {
...
Vector_Resolution
EtaDepResolution::operator () (const double& eta)
{
...
Vector_Resolution
EtaDepResolution::GetResolution(const double& eta) const
{
...
EtaDepResElement
EtaDepResolution::GetEtaDepResElement(const double& eta) const
{
