...
jetMCTable = simplePATJetFlatTableProducer.clone(
    ...
    variables = cms.PSet(
        ...
        ghsFlavLeading = Var("?haveAlgoFlav(1)?algoFlavLeading(1):0", "int8", doc="Heaviest parton flavour in the jet flavour from GHS"),
        ghsFullFlavCode = Var("?haveAlgoFlav(3)?algoFlavCode(3):0", "uint", doc="GHS full flavour code of matched gen jet"),
        ghsFullFlavLeading = Var("?haveAlgoFlav(3)?algoFlavLeading(3):0", "int8", doc="Heaviest parton flavour in the jet full flavour from GHS"),
